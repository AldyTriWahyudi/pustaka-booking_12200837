...
class PenggunaController_12200837 extends BaseController
{
    public function index()
    {
        return view('halaman/pengguna/table', [
            'xx'    => (new Pengguna_12200837())->get()->getResult(),
    ...
    public function simpan(){
        ...
        if( $this->validasi() ){
            $r = (new Pengguna_12200837())->insert($data);
            if($r == false){
    ...
    public function edit($id){
        $data = (new Pengguna_12200837())->where('id', $id)->first();
    ...
    public function patch(){
        ...
        if( $this->validasiPatch() ){
            $r = (new Pengguna_12200837())->update($id, $data);
            if($r == true){
                return redirect()->to('/pengguna-list');
            }else{
    ...
    public function delete(){
        $id = $this->request->getPost('id');
        $r = (new Pengguna_12200837())->delete($id);
